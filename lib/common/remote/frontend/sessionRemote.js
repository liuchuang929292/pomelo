...
module.exports = function createSessionRemote(app) {
 ...
 * @param  {Function} cb(err, sinfo)  callback funtion,
 *                    sinfo would be null if the session not exist.
 */
 ...
 * @param  {Function} cb(err, sinfo)  callback funtion,
 *                    sinfo would be null if the session does not exist.
 */
